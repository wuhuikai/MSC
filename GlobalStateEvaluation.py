...
from GlobalStateEvaluation_Test import show_test_result

from BatchEnv import BatchGlobalFeatureEnv
...
def main():
    ...
    if args.phrase == 'train':
        ...
        env = BatchGlobalFeatureEnv(os.path.join(args.replays_path, '{}.json'.format(args.phrase)),
                                    args.race, args.enemy_race, n_steps=args.n_steps, seed=args.seed,
                                    n_replays=args.n_replays, epoches=args.n_epoch)
        ...
        while True:
            ...
            if path is not None:
                ...
                env = BatchGlobalFeatureEnv(os.path.join(args.replays_path, dataset_path),
                                    args.race, args.enemy_race, n_steps=args.n_steps,
                                            seed=args.seed, n_replays=1, epoches=1)
                model = StateEvaluationGRU(env.n_features)
